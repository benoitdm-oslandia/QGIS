  ...
  , mMainCamera( mainCamera )
{
  ...
  mLayer->setObjectName( "QgsAmbientOcclusionRenderView::Layer" );

  mRendererEnabler = new Qt3DRender::QSubtreeEnabler;
  mRendererEnabler->setEnablement( Qt3DRender::QSubtreeEnabler::Persistent );
  mRendererEnabler->setObjectName( "QgsAmbientOcclusionRenderView" );
...
void QgsAmbientOcclusionRenderView::onTargetOutputUpdate()
{
  if ( mRenderTargetSelector )
  {
    if ( ! mTargetOutputs.isEmpty() )
    {
      ...
      renderTarget->setObjectName( "QgsAmbientOcclusionRenderView::Target" );
...
Qt3DRender::QFrameGraphNode *QgsAmbientOcclusionRenderView::buildRenderPass()
{
