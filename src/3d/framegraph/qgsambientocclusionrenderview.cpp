...
QgsAmbientOcclusionRenderView::QgsAmbientOcclusionRenderView( QObject *parent
    , Qt3DRender::QCamera *mainCamera
    , QSize mSize
    , Qt3DRender::QTexture2D *forwardDepthTexture
    , Qt3DCore::QEntity *rootSceneEntity )
  : QgsAbstractRenderView( parent, "ambient_occlusion" )
...
void QgsAmbientOcclusionRenderView::updateTargetOutputSize( int width, int height )
{
...
Qt3DRender::QFrameGraphNode *QgsAmbientOcclusionRenderView::buildRenderPass( QSize mSize, Qt3DRender::QTexture2D *forwardDepthTexture
    , Qt3DCore::QEntity *rootSceneEntity )
{
  // AO pass
  {
