...
void QgsDepthRenderView::onTargetOutputUpdate()
{
  if ( mRenderTargetSelector )
  {
    if ( ! mTargetOutputs.isEmpty() )
    {
      ...
      depthRenderTarget->setObjectName( "QgsDepthRenderView::Target" );
