...
void Qgs3DExportObject::saveTo( QTextStream &out, float scale, const QVector3D &center )
{
  ...
  {
    const int negativeIndex = - ( verticesCount - i ) - ( int )mIndexes[0]; // mIndexes[0] is used to shift the index according to the first index (not always 0)
