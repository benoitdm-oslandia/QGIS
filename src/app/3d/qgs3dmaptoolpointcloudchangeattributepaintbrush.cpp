...
void Qgs3DMapToolPointCloudChangeAttributePaintbrush::activate()
{
  ...
  mSelectionRubberBand.reset( new QgsRubberBand3D( *mCanvas->mapSettings(), mCanvas->engine(), Qgis::GeometryType::Point ) );
  ...
  mIsActive = true;
  mHighlighterRubberBand.reset( new QgsRubberBand3D( *mCanvas->mapSettings(), mCanvas->engine(), Qgis::GeometryType::Polygon ) );
