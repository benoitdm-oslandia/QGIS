  ...
  , mCanvasName( name )
{
  ...
  // mActionSelectLayerForEdition = new QAction( QgsApplication::getThemeIcon( QStringLiteral( "/mActionSelectLayerForEdition.svg" ) ), tr( "Toggle editing" ), this );
  // mActionSelectLayerForEdition->setCheckable( true );
  // connect( mActionSelectLayerForEdition, &QAction::triggered, this, [this] {
...
void Qgs3DMapCanvasWidget::updateEditionToolBar()
{
  ...
  else
  {
    ...
    // mActionSelectLayerForEdition->setEnabled( false );
    // mActionSelectLayerForEdition->setChecked( false );
...
void Qgs3DMapCanvasWidget::createSnappingToolBar( const QgsSettings &setting )
{
...
void Qgs3DMapCanvasWidget::onSnappingButtonTriggered( QAction *action )
{
