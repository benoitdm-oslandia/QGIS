...
class TestQgsServerWMSDimension(TestQgsServerWMSTestBase):
    ...
    def setUp(self):
        ...
        self.testdata_path = os.path.join(
            self.temporary_path, "qgis_server_accesscontrol"
        )

        self.projectPath = os.path.join(
            self.testdata_path, "project_with_dimensions.qgs"
        )
        self.assertTrue(
    ...
    def wms_request(
        ...
        request,
        extra=None,
        project="project_with_dimensions.qgs",
        version="1.3.0",
    ):
    ...
    def test_wms_getmap_simple_value(self):
        ...
        self._img_diff_error(
            r, h, "WMS_GetMap_Dimension_Elevation_RangeElevation_Value"
        )
