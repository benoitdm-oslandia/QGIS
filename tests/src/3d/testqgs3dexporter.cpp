...
void TestQgs3DExporter::test3DSceneExporterInstancedTrs()
{
  ...
  do3DSceneExport( u"instanced_trs_export"_s, 1, 2, 0, 72, scene, layerPointsZ.get(), &engine );
...
void TestQgs3DExporter::test3DSceneExporterInstancedDataDefinedTrs()
{
  ...
  do3DSceneExport( u"instanced_trs_dd_export"_s, 1, 3, 0, 108, scene, layerPointsZ.get(), &engine );
